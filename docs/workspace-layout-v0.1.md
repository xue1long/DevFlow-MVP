...
> **状态**：⏳ 设计阶段（v0.3 实施）。v0.2 及之前版本按历史布局（specs/plans/review 散在根）。
>
> 约定 DevFlow 在用户项目根目录下产生的运行时文档如何分类、归档、命名。
> 与 [`DOCS_GUIDELINES.md`](./DOCS_GUIDELINES.md) 互补——后者约定 DevFlow 自身仓库文档，本文件约定用户项目中的 DevFlow 产物。
